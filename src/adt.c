...
int adt_check_header(void *adt) { return _adt_check_node_offset(adt, 0); }
...
struct adt_property *adt_get_property_namelen(void *adt, int offset,
                                              const char *name,
                                              size_t namelen) {
...
int adt_subnode_offset_namelen(void *adt, int offset, const char *name,
                               size_t namelen) {
...
int adt_get_reg(void *adt, int *path, const char *prop, int idx, u64 *paddr,
  ...
  u32 reg_len = 0;
  u32 *reg = adt_getprop(adt, node, prop, &reg_len);
